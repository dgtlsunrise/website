...
- Documented Polar checkout: `https://buy.polar.sh/polar_cl_aIrywIIxJ2cOwj70VQAcJn2umEgSS9kWBMUJS241Dll`. Ask the Bot in plain language, then redeem on the install. Never invent another Polar checkout URL.
